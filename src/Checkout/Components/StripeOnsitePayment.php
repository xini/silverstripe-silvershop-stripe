...
use Omnipay\Stripe\AbstractGateway as StripeAbstractGateway;
...
class StripeOnsitePayment extends OnsitePayment
{
    ...
    protected function getGateway($order)
    {
        if (!isset($this->gateway)) {
            ...
            $this->isStripe = ($this->gateway instanceof StripeAbstractGateway);
        }
    ...
    public function getFormFields(Order $order)
    {
        ...
        $configName = $this->gateway instanceof PaymentIntentsGateway ? 'Stripe_PaymentIntents' : 'Stripe';
